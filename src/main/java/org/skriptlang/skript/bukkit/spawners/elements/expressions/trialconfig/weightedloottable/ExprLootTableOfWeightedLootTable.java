package org.skriptlang.skript.bukkit.spawners.elements.expressions.trialconfig.weightedloottable;
...
import org.skriptlang.skript.bukkit.spawners.util.WeightedLootTable;
...
public class ExprLootTableOfWeightedLootTable extends SimplePropertyExpression<WeightedLootTable, LootTable> {
	...
	static {
		register(SpawnerModule.SYNTAX_REGISTRY, ExprLootTableOfWeightedLootTable.class, LootTable.class,
			"weighted loot[ ]table", "weightedloottables");
	}
