package org.skriptlang.skript.bukkit.spawners.elements.expressions.trialconfig;
...
public class ExprTrialConfigMobCount extends SimplePropertyExpression<TrialSpawnerConfig, Float> {
	...
	public boolean init(Expression<?>[] expressions, int matchedPattern, Kleenean isDelayed, ParseResult parseResult) {
		simultaneous = parseResult.hasTag("simultaneous");
	...
	protected String getPropertyName() {
		return (simultaneous ? "simultaneous " : "total ") + "mob count";
	}
